...
bool calculatorTests()
{
    ...
    int result1 = calculate(testSequence1, &correctInput);
    ...
    correctInput = true;
    int result2 = calculate(testSequence2, &correctInput);
    if (correctInput)
    {
        return false;
    }
    ...
    correctInput = true;
    int result3 = calculate(testSequence3, &correctInput);
    if (correctInput)
    {
        return false;
    }
    ...
    correctInput = true;
    int result4 = calculate(testSequence4, &correctInput);
    return !correctInput;
}